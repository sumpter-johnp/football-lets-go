# HC-regime backtest verdict, 2018 movers — does head-coach program identity travel?

## neutral_pass_rate
- movers with usable data: 6
- HC-regime MAE: 0.0610 | program MAE: 0.0358
- head-to-head: HC regime 1 – 5 program (sign-test p = 0.219)
- **edge: program identity**

## sec_per_play
- movers with usable data: 2
- HC-regime MAE: 3.7604 | program MAE: 8.5000
- head-to-head: HC regime 2 – 0 program (sign-test p = 0.500)
- **edge: HC regime**

## explosive_pass_rate
- movers with usable data: 6
- HC-regime MAE: 0.0390 | program MAE: 0.0351
- head-to-head: HC regime 4 – 2 program (sign-test p = 0.688)
- **edge: program identity**

## Overall
Across all metric × mover pairs: HC regime 7 – 7 program (sign-test p = 1.000).
