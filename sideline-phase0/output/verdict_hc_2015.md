# HC-regime backtest verdict, 2015 movers — does head-coach program identity travel?

## neutral_pass_rate
- movers with usable data: 4
- HC-regime MAE: 0.0948 | program MAE: 0.1297
- head-to-head: HC regime 2 – 2 program (sign-test p = 1.000)
- **edge: HC regime**

## sec_per_play
- movers with usable data: 1
- HC-regime MAE: 0.5000 | program MAE: 1.5000
- head-to-head: HC regime 1 – 0 program (sign-test p = 1.000)
- **edge: HC regime**

## explosive_pass_rate
- movers with usable data: 4
- HC-regime MAE: 0.0175 | program MAE: 0.0148
- head-to-head: HC regime 2 – 2 program (sign-test p = 1.000)
- **edge: program identity**

## Overall
Across all metric × mover pairs: HC regime 5 – 4 program (sign-test p = 1.000).
